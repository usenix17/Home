...
?>
<DIV ID="tech_support_details_user_information_<?=$user_id?>"></DIV>
<SCRIPT>load('/control_user/edit/user_id/<?=$user_id?>',"#tech_support_details_user_information_<?=$user_id?>");</SCRIPT>
