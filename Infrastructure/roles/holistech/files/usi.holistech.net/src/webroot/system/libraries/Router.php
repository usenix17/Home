...
class CI_Router {
	...
	function _set_routing()
	{
		...
		// Added by Jason Karcz
		// The URI string's first segment needs to be removed and set as the COURSENAME
		// I also had to re-attach the clientname in the base_url function
		$segments = explode('/',$this->uri->uri_string);
		array_shift($segments);
		define('COURSENAME',strtolower(array_shift($segments)));
		$this->uri->uri_string = implode('/',$segments);
